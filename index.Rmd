...
- Sesión 5. Aplicaciones con los paquetes `tidyr` y `dplyr`. 
    * Se practicaran actividades de lectura (sesión 3) y manipulación de data.frame (sesión 4) usando un conjunto de datos longitudinal.
    * Una presentación excelente sobre `dplyr`: <https://r-in-grenoble.github.io/presentation/dplyr.html#1>
