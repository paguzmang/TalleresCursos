...
library(kableExtra)   # complementos obligatorios para kable
...
- [Taller interactivo](http://gauss.inf.um.es:8080/tabular-tablas/#section-agrupar-filas-y-columnas){target="Blank7"} para prácticar `r colpkg("kableExtra")`.
...
Descargue el `png` producido [aquí](mitabla.png).
