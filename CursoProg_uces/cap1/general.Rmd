...
```
    ...
    a. Descargue el archivo `pesticidas.RData` desde [aquí](). Cree y establezca un directorio de trabajo. Dentro de esta carpeta, ubique el archivo `pesticidas.RData`. También cree un nuevo script que contenga el código dado arriba. Verifique que su espacio de trabajo este vacio.
